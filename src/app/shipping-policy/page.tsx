  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:text-foreground prose-strong:text-foreground prose-ul:text-muted-foreground prose-li:text-muted-foreground">
        ...
        <p className="text-muted-foreground"><em>Please note: Delivery times are estimates and may vary due to carrier delays or other unforeseen circumstances.</em></p>
        ...
        <p className="text-muted-foreground">
          If you haven’t received your order within 10 days of receiving your shipping confirmation email, please contact us at <a href="mailto:support@petcouture.com" className="text-primary hover:underline">support@petcouture.com</a> with your name and order number, and we will look into it for you.
        </p>
