  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert prose-p:text-muted-foreground prose-headings:text-foreground prose-strong:text-foreground">
        <p>
          We want you and your pup to be completely happy with your Pawsome Outfits purchase! If something isn't right, here's how we can help.
        </p>
        ...
        <p>
          To start a return or exchange, please email us at <a href="mailto:returns@pawsomeoutfits.com" className="text-primary hover:underline">returns@pawsomeoutfits.com</a> with your order number and the reason for the return/exchange.
        </p>
        <p>
        ...
        <p>
          If you have any questions concerning our return policy, please contact us at <a href="mailto:support@pawsomeoutfits.com" className="text-primary hover:underline">support@pawsomeoutfits.com</a>.
        </p>
      </div>
    </div>
  );
