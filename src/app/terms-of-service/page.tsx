    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:text-foreground prose-strong:text-foreground prose-ul:text-muted-foreground prose-li:text-muted-foreground">
        ...
        <p className="text-muted-foreground">
          By accessing or using our website [Your Website URL] (the "Site") and the services offered by PetCouture ("we," "us," or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Site or our services.
        </p>
        ...
        <p className="text-muted-foreground">
          The Site and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by PetCouture, its licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
        </p>
         <p className="text-muted-foreground">
        ...
        <p className="text-muted-foreground">
          Questions about the Terms of Service should be sent to us at <a href="mailto:support@petcouture.com" className="text-primary hover:underline">support@petcouture.com</a>.
        </p>
      </div>
    </div>
  );
